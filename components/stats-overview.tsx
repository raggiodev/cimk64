    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card className="border-2 border-yellow-500/20 hover:border-yellow-500/50 transition-colors">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">25 {t("total_victories")}</p>
        </CardContent>
      </Card>
      <Card className="border-2 border-blue-500/20 hover:border-blue-500/50 transition-colors">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">25 {t("individual_victories")}</p>
        </CardContent>
      </Card>
      ...
      <Card className="border-2 border-purple-500/20 hover:border-purple-500/50 transition-colors">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Fernando (2) y Benizio (1)</p>
        </CardContent>
      </Card>
    </div>
  )
